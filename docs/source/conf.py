...
htmlhelp_basename = 'pytest_bug_k-doc'
...
latex_documents = [
    (master_doc, 'pytest_bug_k.tex', 'pytest_bug_k Documentation',
     'COM', 'manual'),
]
...
man_pages = [
    (master_doc, 'pytest_bug_k', 'pytest_bug_k Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pytest_bug_k', 'pytest_bug_k Documentation',
     author, 'pytest_bug_k', 'One line description of project.',
     'Miscellaneous'),
]
